            ...
            <Grid item xs={12} sm={6} lg={4}>
                <Card>
                    ...
                    <CardContent>
                        ...
                        <Typography type="headline" component="h3" style={{width: '100%', margin: '30px 0px 0px', textAlign: 'center'}}>
                            {this.state.quantity} - ${this.state.price}
                        </Typography>
                        <a href={"https://www.google.com/maps?q="+this.state.latitude+','+this.state.longitude} target="_blank">
                            Go to map
                        </a>
                        <Grid container>
                            <Grid item xs={12}>
